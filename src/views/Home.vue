<template>
    <div id="home" ref="scrollDom">
        ...
        <div class="back-top" v-if="posY>600" @click="backTop"></div>
        <!--  -->
        ...
        <div class="view-wrapper">
            ...
            >
                <main>
                    ...
                    <!--  -->
                    <div class="scroll-item" v-for="item in scrollProducts" :key="item.brandId" id="productList">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            backTop() {
                let domId = "dom" + this.scrollMenu[0].brandId;
                this.$refs.scrollProduct.scrollToElement(
                    document.getElementById(domId),
                    150
                );
