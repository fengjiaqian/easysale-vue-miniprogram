<template>
  <div id="detail" class="pt90" v-show="domShow">
    ...
    <div class="body">
      ...
      <div
        class="D-options"
        v-if="product.returnState || product.awardState || product.displayState"
      >
        ...
        <div
          class="reward"
          v-if="product.displayState&&product.displayAward&&(sourceType=='display'||sourceType=='')"
        >陈列奖励：{{product.displayAward}}</div>
      </div>
    ...
    <div
      ...
      v-if="sourceType=='display'"
      @click="apply"
    >申请陈列</div>
    <div
      class="bottom-btn"
      :class="{'isIphoneX':isIphoneX}"
      v-if="sourceType=='redemption'"
      @click="redemption"
    >申请兑奖</div>
    <div
      class="bottom-btn"
      :class="{'isIphoneX':isIphoneX}"
      v-if="sourceType=='return'"
      @click="returnGoods"
    >申请退货</div>
...
export default {
  ...
  components: {},
  created() {
    this.$createTalkingData("shopDetailpage", "shopDetailpage", {}, 1);
