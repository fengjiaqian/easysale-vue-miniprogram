<template>
  <div class="common">
    <!-- wx  销售人员   编辑客户信息   editCustomerInfor -->
    ...
    <div class="shopname"  style="margin-top:10px;">
    ...
    <div class="address" style="margin-top:10px;">
      <div class="left">销售负责人 :</div>
      <input class="right" value="小黑" type="text" placeholder="请输入店铺地址">
    </div>
    <!-- <div class="license">
